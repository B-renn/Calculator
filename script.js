// Defining constant values used in functions below
...
function numberKeydown(e) {
	...
	for (var i = 0; i < numberButtons.length; i++) {
		if ((keyDownCode == numberButtons[i].dataset.numpad) || (keyDownCode == numberButtons[i].dataset.key)){					
			keyDownKey = input.innerHTML + keyDownKey;
